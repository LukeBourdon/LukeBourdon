...
| Action | ACT-6.1: Apply proportionate lawful screening to relevant roles and contractors |
| Owner / deadline | People Lead / 2026-12-13 / P2 |
...
| Action | ACT-6.2: Maintain template review and sample new contracts quarterly |
| Owner / deadline | People Lead / 2027-03-13 / P3 |
...
| Status | Partial |
| Gap / implication | The described baseline does not provide complete, repeatable assurance for this topic; treatment below is required. |
| Action | ACT-6.3: Implement role-based programme and measure learning and reporting |
...
| Status | Implemented |
| Gap / implication | No gap identified within the limited fictional sample; continue assurance. |
| Action | ACT-6.4: Maintain fair review and communicate how security cases enter HR process |
| Owner / deadline | People Lead / 2027-03-13 / P3 |
...
| Status | Partial |
| Gap / implication | The described baseline does not provide complete, repeatable assurance for this topic; treatment below is required. |
| Action | ACT-6.5: Brief departing staff and record continuing obligations |
| Owner / deadline | People Lead / 2026-12-13 / P2 |
...
| Status | Partial |
| Gap / implication | The described baseline does not provide complete, repeatable assurance for this topic; treatment below is required. |
| Action | ACT-6.6: Reconcile agreements to active contractor and supplier access |
| Owner / deadline | People Lead / 2026-12-13 / P2 |
...
| Status | Partial |
| Gap / implication | The described baseline does not provide complete, repeatable assurance for this topic; treatment below is required. |
| Action | ACT-6.7: Issue remote-work handling and device rules |
...
| Status | Partial |
| Gap / implication | The described baseline does not provide complete, repeatable assurance for this topic; treatment below is required. |
| Action | ACT-6.8: Publish immediate reporting route and practise disclosure after a click |
| Owner / deadline | Security Lead / 2026-10-14 / P1 |
| Closure evidence | Tabletop and training validate reports reach the response team |
| Action status | Open |
